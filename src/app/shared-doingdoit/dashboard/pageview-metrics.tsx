...
export default function PageViewrMetrics({ className }: { className?: string }) {
  ...
  const [ uaerDailyData, setUserDailyData ] = useState([] as any);
  ...
  const fetchDailyData = async (
    ...
    const response = await fetch('/api/doingdoit/user/getStatisticsDailyVisit', {
      method: 'POST',
      headers: {
        ...
        action: (
          <div className='flex flex-wrap items-center justify-between gap-3'>
            ...
            <Button
              ...
              className=" w-24  h-9   @lg:w-auto dark:bg-gray-100 dark:text-white dark:active:bg-gray-100">
