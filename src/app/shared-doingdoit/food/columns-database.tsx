        ...
        <Checkbox
          ...
          {...(onChecked && {
            onChange: () =>  {
              ...
              // if checked items is more than 3, then return
    ...
    render: (_: any, row: any) => (
      ...
      "
          ...
          onClick={() => {
            ...
            ///onChecked(row.foodCode);
  
            ///onDeleteItem(row.foodCode);
  
            ////alert('test');  

            onChecked && onChecked(row.foodCode);

            ///////////onClickFood && onClickFood(row.foodCode);
