...
export const getColumns = ({
...

  {
    ...
    render: (value: Date) => (
      ...
      <span className="flex flex-row items-center justify-center text-xs xl:text-base text-grey-9">
...

  {
    ...
    width: "30%",
    render: (value: string) => (
      <Text className="text-dark text-xs xl:text-base font-extrabold text-center ">{value}P</Text>
    ),
  },
