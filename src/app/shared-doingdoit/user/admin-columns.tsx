...
import DeletePopover from '@/app/shared-doingdoit/delete-popover';
  ...
  /*
  {
    ...
    render: (value: string) => (
      <Text className='text-center'>{
        value === 'feedbackWriter' ? '영양사' :
        value === 'boardManager' ? '게시판 관리자' :
        value === 'customerManger' ? '고객 관리자' :
        value === 'admin' ? '관리자' :
        value === 'user' ? '사용자' : '비회원'
      }</Text>
    ),
    ...
    render: (_: string, row: any) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        */}
        ...
        <DeletePopover
          title={`삭제`}
          description={`${row.id}번 계정을 삭제하시겠습니까?`}
