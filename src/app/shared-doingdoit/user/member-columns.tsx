...
export const getColumns = ({
...

  {
    title: (
      <HeaderCell
        ...
        //sortable
        //ascending={
        //  sortConfig?.direction === 'asc' && sortConfig?.key === 'regType'
        //}
      />
    ),
    onHeaderCell: () => onHeaderCellClick('regType'),
    dataIndex: 'regType',
    key: 'regType',
    width: 100,
    ...
    render: (
      ...
      <div>
        ...
        <Link
          ...
          href={`/user/member/${row.id}?sequenceNumber=${row?.sequenceNumber}`}

          className=' hover:font-bold hover:underline'
        >
        <TableAvatar
          src={row?.avatar || '/usermain/images/avatar.svg'}
          name={row?.nickname || '닉네임 없음'}
  ...
  */
  ...
  /*
  {
    ...
    width: 100,
    render: (value: string) => (
      <Text className='  text-center '>{value} kg</Text>
    ),
  },
  {
    title: <HeaderCell title="키" />,
    dataIndex: 'height',
    key: 'height',
    width: 100,
    render: (value: string) => (
