...
const FormContainerHome2: NextPage<FormContainerType> = ({
  dimensionText,
  messageText,
  propBackgroundColor,
  propWidth,
    ...
    ">
      ...
      <button 
        ...
        onClick={() => {
          ...
          if (session) {
            window.location.href = "/usermain/diet";
          } else {
            signIn();
          }
      ...
      <div
        className="
          absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-[50%] bg-gray-200
      ...
      <div className="absolute  top-[calc(50%_-_60px)] left-[calc(50%_-_40px)]   xl:top-[calc(50%_-_131.5px)] xl:left-[calc(50%_-_87.5px)] flex flex-col items-center justify-start gap-[10px] xl:gap-[20px]">
...
export default FormContainerHome2;
