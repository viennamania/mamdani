  ...
  function handleDelete(id: string | string[]) {
    ...
    */
    ...
    const deleteData = async () => {
      ...
      await fetch(`/api/doingdoit/faq/deleteOneCategory?id=${id}`);
  ...
  */
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      console.log('fetchData posts.data.categories : ' + posts?.data?.categories);
  ...
  */
  ...
  const handleIncrementOrderNumber = (id: string) => {
    ...
    const result = async () => {
      ...
      const res = await fetch('/api/doingdoit/faq/incrementCategoryOrderNumber?id=' + id );
  ...
  const handleDecrementOrderNumber = (id: string) => {
    ...
    const result = async () => {
      ...
      const res = await fetch('/api/doingdoit/faq/decrementCategoryOrderNumber?id=' + id );
