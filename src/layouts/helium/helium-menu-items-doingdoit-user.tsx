  ...
  */
  {
    ...
    dropdownItems: [
      ...
      {
        name: '유형별 가이드',
        href: routes.usermain.boardGuide,
      },
      {
        name: '공지사항',
        href: routes.usermain.boardNotice,
      },
      {
        name: 'FAQ',
        href: routes.usermain.boardFaq,
      },
    ],
  },
  ...
  /*
  {
    ...
    dropdownItems: [
      {
        name: '일간',
        href: routes.usermain.statistics,
      },
      {
        name: '주간/월간/전체',
        href: routes.usermain.statisticsWeekly,
      },
